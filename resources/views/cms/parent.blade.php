...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <a href="#" class="dropdown-item">
            ...
            <span class="float-right text-muted text-sm">{{  $notification->created_at}} mins</span>
          </a>
        @endforeach

          <div class="dropdown-divider"></div>
          <a href="{{ route('admin.products-notifications') }}" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('admin_files/dist/img/user3-128x128.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('admin_files/dist/img/user3-128x128.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('admin.brokers.create') }}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Create</p>
                    </a>
                </li>
        ...
        <li class="nav-item ">
         ...
         <li class="nav-header">Roles & Permissions</li>
          ...
          <li class="nav-item ">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.auth.edit-profile') }}" class="nav-link">
