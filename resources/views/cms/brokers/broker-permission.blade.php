                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="icheck-success d-inline">
                                        <input type="checkbox" onchange="updateBrokerPermission('{{ $broker->id }}','{{ $permission->id }}')"
...
@section('scripts')
  <script>
      function updateBrokerPermission(brokerId, permission) {
        //JS axios

        axios.put('/admin/brokers/'+brokerId+'/permissions',{
